 ...
 */
public class ProcessReportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_show_process_report, container, false);
    }
    ...
    public void populateData() {
        ...
        for(int a = 0 ; a < arrayOfReports.size(); a++){
            if(arrayOfReports.get(a).getStatus().equalsIgnoreCase("Proses")){
                arrayOfProcessReports.add(arrayOfReports.get(a));
            }
        }


        ListView listView = (ListView) getActivity().findViewById(R.id.spp_report_list);
